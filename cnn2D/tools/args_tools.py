...
parser.add_argument('--max-epochs', default=100, type=int, metavar='',
...
parser.add_argument('--channel-factor', default=210, type=int, metavar='',
                    help='The number of the output frames (default=18)')

parser.add_argument("--I-lat-l", default=24.6625, type=float, metavar='',
                    help='The lowest latitude of the input frames')
parser.add_argument("--I-lat-h", default=25.4, type=float, metavar='',
                    help='The highest latitude of the input frames')
parser.add_argument("--I-lon-l", default=121.15, type=float, metavar='',
                    help='The lowest longitude of the input frames')
parser.add_argument("--I-lon-h", default=121.8875, type=float, metavar='',
