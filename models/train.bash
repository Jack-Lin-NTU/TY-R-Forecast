...
# clear
# python train_GRUs.py --model TRAJGRU --able-cuda --target-RAD \
...
clear
python train_GRUs.py --model FLOWGRU --able-cuda --target-RAD \
--gpu 0 --lr 0.00005 --clip --clip-max-norm 1 --weight-decay 0 --lr-scheduler \
--max-epochs 10 --batch-size 5 --train-num 11 --optimizer Adam --value-dtype float32