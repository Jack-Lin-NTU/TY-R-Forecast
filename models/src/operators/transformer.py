...
class PositionwiseCNN(nn.Module):
    ...
    def __init__(self, d_channel, d_ff, dropout=0.1, groups=6):
        ...
        self.w_1 = nn.Conv2d(d_channel*groups, d_ff*groups, kernel_size=1, stride=1, padding=0, groups=groups)
        self.w_2 = nn.Conv2d(d_ff*groups, d_channel*groups, kernel_size=1, stride=1, padding=0, groups=groups)
        self.dropout = nn.Dropout(dropout)
