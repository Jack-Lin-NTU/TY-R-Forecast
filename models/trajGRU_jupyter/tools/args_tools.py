...
args.I_shape = (round((args.I_x_h-args.I_x_l)/args.res_degree)+1, round((args.I_y_l-args.I_y_l)/args.res_degree)+1)
args.F_shape = (round((args.F_x_h-args.F_x_l)/args.res_degree)+1, round((args.F_y_l-args.F_y_l)/args.res_degree)+1)
args.O_shape = (round((args.O_x_h-args.O_x_l)/args.res_degree)+1, round((args.O_y_l-args.O_y_l)/args.res_degree)+1)
